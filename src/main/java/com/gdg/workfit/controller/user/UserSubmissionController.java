...
public class UserSubmissionController {
    ...
    public SubmissionDto.SubmissionResponse start(@RequestBody SubmissionDto.StartRequest request) {
        return submissionService.toResponse(submissionService.start(request));
    }
    ...
    public SubmissionDto.SubmissionResponse saveDraft(
        ...
        return submissionService.toResponse(submissionService.saveDraft(submissionId, request));
    }
    ...
    public SubmissionDto.SubmissionResponse submit(
        ...
        return submissionService.toResponse(submissionService.submit(submissionId, request));
    }
